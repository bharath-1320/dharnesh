...
class RequestAnalyticsTest {
    ...
    void defaultConstructor_initializesDefaults() {
        ...
        // By default, id is null until persisted
        assertNull(ra.getId());
        ...
        // requestCount default is 1
        assertEquals(1, ra.getRequestCount());

        // lastRequested default is null until set
        assertNull(ra.getLastRequested());

        // cacheHit default is false
    ...
    void allArgsConstructor_andGetters() {
        ...
        // lastRequested should have been set to something very close to now
        ...
        // requestCount default in constructor is also 1
        assertEquals(1, ra.getRequestCount());
    }
    ...
    void incrementRequestCount_incrementsAndUpdatesTimestamp() throws InterruptedException {
        ...
        Thread.sleep(10); // ensure clock moves forward
