...
class GlobalExceptionHandlerTest {
    ...
    @BeforeEach
    void setup() {
        // Standalone setup: only our TestController + our GlobalExceptionHandler
        mvc = MockMvcBuilders
    ...
    // A minimal controller that throws each exception
    @RestController
    static class TestController {
        ...
        // Force the HttpMessageNotReadableException directly
